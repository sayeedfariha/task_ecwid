    ...
    <section className="flex flex-col xl:flex-row h-auto xl:h-[100vh] w-screen">
      <div className="flex flex-col justify-center w-screen xl:w-[58vw] h-auto xl:h-screen  text-section p-12">
        ...
        <p className="text-2xl text-gray-600 my-6">
          ...
          <button className="flex items-center justify-between bg-yellow-200 text-gray-900 font-xs xl:font-medium rounded-full xl:p-6 p-3 shadow hover:bg-yellow-300 text-2xl w-60 hover:w-64 xl:w-80 xl:hover:w-96 ease-in duration-300">
